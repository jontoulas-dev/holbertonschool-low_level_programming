...
BUILD_DATA = 0.000277,PROCESS = 0.000224, REDUCE = 0.000101 for a total of 0.000605 seconds. Based on these results, it is clear that BUILD_DATA and PROCESS are the two most resource-intensive stages, accounting for over 82% of the total runtime. Consequently, these are the two priority areas to optimize in order to improve overall efficiency and reduce energy consumption.